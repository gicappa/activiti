...
public class ProcessEngineEndpoint {
  ...
  public Map<String, Object> invoke() {
    ...
    var processDefinitions = processEngine.getRepositoryService()
      .createProcessDefinitionQuery().orderByProcessDefinitionKey().asc().list();
    var processDefinitionKeys = new ArrayList<>();
    ...
    // Process instances
    var processInstanceCountMap = new HashMap<>();
    ...
    var completedProcessInstanceCountMap = new HashMap<String, Object>();
    ...
    metrics.put("completedTaskCountToday",
      processEngine.getHistoryService().createHistoricTaskInstanceQuery().finished()
        .taskCompletedAfter(
          new Date(System.currentTimeMillis() - secondsForDays())).count());
