...
public class StartMessageDeployedEventProducer extends AbstractActivitiSmartLifeCycle {
  ...
  static {
    LoggerFactory.getLogger(StartMessageDeployedEventProducer.class);
  }

  private final RepositoryService repositoryService;
  private final ManagementService managementService;
  private final APIProcessDefinitionConverter converter;
  private final StartMessageSubscriptionConverter subscriptionConverter;
  private final List<ProcessRuntimeEventListener<StartMessageDeployedEvent>> listeners;
  ...
  static class FindStartMessageEventSubscriptions implements
    Command<List<MessageEventSubscriptionEntity>> {
