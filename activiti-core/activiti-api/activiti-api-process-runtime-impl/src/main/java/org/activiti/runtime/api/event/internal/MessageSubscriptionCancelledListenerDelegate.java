...
public class MessageSubscriptionCancelledListenerDelegate implements ActivitiEventListener {
  ...
  private final List<ProcessRuntimeEventListener<MessageSubscriptionCancelledEvent>> processRuntimeEventListeners;

  private final ToMessageSubscriptionCancelledConverter converter;
