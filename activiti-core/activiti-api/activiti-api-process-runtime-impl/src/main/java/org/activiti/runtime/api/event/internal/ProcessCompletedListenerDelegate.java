...
public class ProcessCompletedListenerDelegate implements ActivitiEventListener {
  ...
  private final List<ProcessRuntimeEventListener<ProcessCompletedEvent>> processRuntimeEventListeners;

  private final ToProcessCompletedConverter processCompletedConverter;
