...
public class ToVariableCreatedConverter implements
  EventConverter<VariableCreatedEvent, ActivitiVariableEvent> {
  ...
  public Optional<VariableCreatedEvent> from(ActivitiVariableEvent internalEvent) {
    ...
    return Optional.of(
      new VariableCreatedEventImpl(variableInstance, internalEvent.getProcessDefinitionId()));
  }
}
