...
public class ProcessCandidateStarterEventConverterHelperTest {
  ...
  public void isProcessCandidateStarterUserLink_when_processDefId_userId_and_typeCandidate() {
    IdentityLink identityLink = createUserIdentityLink("aProcessDefId", "aUserId",
      IdentityLinkType.CANDIDATE);
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterUserLink(
      identityLink)).isTrue();
  }
  ...
  public void isNotProcessCandidateStarterUserLink_when_processDefId_isNull() {
    ...
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterUserLink(
      identityLink)).isFalse();
  }

  @Test
  public void isNotProcessCandidateStarterUserLink_when_userId_isNull() {
    IdentityLink identityLink = createUserIdentityLink("aProcessDefId", null,
      IdentityLinkType.CANDIDATE);
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterUserLink(
      identityLink)).isFalse();
  }
  ...
  public void isProcessCandidateStarterGroupLink_when_processDefId_groupId_and_typeCandidate() {
    IdentityLink identityLink = createGroupIdentityLink("aProcessDefId", "aGroupId",
      IdentityLinkType.CANDIDATE);
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterGroupLink(
      identityLink)).isTrue();
  }

  @Test
  public void isNotProcessCandidateStarterGroupLink_when_processDefId_isNull() {
    IdentityLink identityLink = createGroupIdentityLink(null, "aGroupId",
      IdentityLinkType.CANDIDATE);
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterGroupLink(
      identityLink)).isFalse();
  }
  ...
  public void isNotProcessCandidateStarterGroupLink_when_groupId_isNull() {
    IdentityLink identityLink = createGroupIdentityLink("aProcessDefId", null,
      IdentityLinkType.CANDIDATE);
    assertThat(processCandidateStarterEventConverterHelper.isProcessCandidateStarterGroupLink(
      identityLink)).isFalse();
  }
  ...
  private IdentityLinkEntityImpl createUserIdentityLink(String processDefinitionId, String userId,
    String type) {
    return createIdentityLink(processDefinitionId, userId, null, type);
  }

  private IdentityLinkEntityImpl createGroupIdentityLink(String processDefinitionId, String groupId,
    String type) {
    return createIdentityLink(processDefinitionId, null, groupId, type);
  }

  private IdentityLinkEntityImpl createIdentityLink(String processDefinitionId, String userId,
