...
public class ProcessCreatedListenerDelegate implements ActivitiEventListener {
  ...
  private final List<ProcessRuntimeEventListener<ProcessCreatedEvent>> listeners;

  private final ToAPIProcessCreatedEventConverter entityCreatedEventConverter;
