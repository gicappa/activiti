...
public class ProcessCandidateStarterGroupAddedListenerDelegate implements ActivitiEventListener {
  ...
  private final List<ProcessRuntimeEventListener<ProcessCandidateStarterGroupAddedEvent>> listeners;

  private final ToAPIProcessCandidateStarterGroupAddedEventConverter processCandidateStarterGroupAddedEventConverter;
