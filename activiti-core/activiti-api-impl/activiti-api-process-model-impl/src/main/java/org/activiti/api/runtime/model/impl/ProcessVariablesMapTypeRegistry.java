...
public class ProcessVariablesMapTypeRegistry {
  ...
  private static final Map<Class<?>, String> classRegistry = new HashMap<>();
  private static final List<Class<?>> scalarTypes = Arrays.asList(int.class,
    byte.class,
    short.class,
    boolean.class,
    long.class,
  ...
  private static final Class<?>[] containerTypes = {Map.class,
    JsonNode.class,
    List.class,
    Set.class};
