...
public class ResourceFinder {
  ...
  public List<Resource> discoverResources(ResourceFinderDescriptor resourceFinderDescriptor)
    ...
    if (resourceFinderDescriptor.shouldLookUpResources()) {
      for (var suffix : resourceFinderDescriptor.getLocationSuffixes()) {
        var path = resourceFinderDescriptor.getLocationPrefix() + suffix;
      ...
      if (resources.isEmpty()) {
        ...
        var foundResources = resources.stream().map(Resource::getFilename)
