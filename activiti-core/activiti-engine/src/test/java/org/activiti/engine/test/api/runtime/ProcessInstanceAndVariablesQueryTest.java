...
public class ProcessInstanceAndVariablesQueryTest extends PluggableActivitiTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    var startMap = new HashMap<String, Object>();
  ...
  protected void tearDown() throws Exception {
    for (var deployment : repositoryService.createDeploymentQuery().list()) {
  ...
  public void testQuery() {
    var processInstance = runtimeService.createProcessInstanceQuery().includeProcessVariables()
      .variableValueEquals("anothertest", 123).singleResult();
    var variableMap = processInstance.getProcessVariables();
    assertThat(variableMap).hasSize(1);
    assertThat(variableMap.get("anothertest")).isEqualTo(123);

    var instanceList = runtimeService.createProcessInstanceQuery().includeProcessVariables().list();
  ...
  public void testOrQuery() {
    var processInstance = runtimeService.createProcessInstanceQuery().includeProcessVariables()
      .or().variableValueEquals("undefined", 999).variableValueEquals("anothertest", 123).endOr()
      .singleResult();
    var variableMap = processInstance.getProcessVariables();
    assertThat(variableMap).hasSize(1);
    assertThat(variableMap.get("anothertest")).isEqualTo(123);
    ...
    processInstance = runtimeService.createProcessInstanceQuery().includeProcessVariables()
      .or().variableValueEquals("anothertest", 123).variableValueEquals("undefined", 999).endOr()
      .singleResult();
    variableMap = processInstance.getProcessVariables();
    assertThat(variableMap).hasSize(1);
    assertThat(variableMap.get("anothertest")).isEqualTo(123);
    ...
    processInstance = runtimeService.createProcessInstanceQuery().includeProcessVariables()
      .or().variableValueEquals("anothertest", 999).variableValueEquals("anothertest", 123).endOr()
      .singleResult();
    variableMap = processInstance.getProcessVariables();
    assertThat(variableMap).hasSize(1);
    assertThat(variableMap.get("anothertest")).isEqualTo(123);
  ...
  public void testOrQueryMultipleVariableValues() {
    var query0 = runtimeService.createProcessInstanceQuery().includeProcessVariables().or();
    for (int i = 0; i < 20; i++) {
    ...
    var query1 = runtimeService.createProcessInstanceQuery().includeProcessVariables().or()
    ...
    var processInstance = query1.singleResult();
    var variableMap = processInstance.getProcessVariables();
    assertThat(variableMap).hasSize(1);
    assertThat(variableMap.get("anothertest")).isEqualTo(123);

    var query2 = runtimeService.createProcessInstanceQuery().includeProcessVariables().or();
    for (int i = 0; i < 20; i++) {
    ...
    var query3 = runtimeService.createProcessInstanceQuery().includeProcessVariables().or()
      .variableValueEquals("anothertest", 123);
    for (int i = 0; i < 20; i++) {
  ...
  public void testOrProcessVariablesLikeIgnoreCase() {
    var instanceList = runtimeService
