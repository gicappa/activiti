...
public class NonCascadeDeleteTest extends PluggableActivitiTestCase {
  ...
  public void testHistoricProcessInstanceQuery(){
    ...
    var processInstanceId = runtimeService.startProcessInstanceByKey(PROCESS_DEFINITION_KEY)
      .getId();
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
        var processInstance = historyService.createHistoricProcessInstanceQuery().processInstanceId(
        ...
        var processInstanceAfterDelete = historyService.createHistoricProcessInstanceQuery().processInstanceId(
          processInstanceId).singleResult();
