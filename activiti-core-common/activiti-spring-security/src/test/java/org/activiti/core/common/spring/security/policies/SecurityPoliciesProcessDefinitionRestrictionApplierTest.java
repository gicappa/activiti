...
public class SecurityPoliciesProcessDefinitionRestrictionApplierTest {
  ...
  private final SecurityPoliciesProcessDefinitionRestrictionApplier restrictionApplier = new SecurityPoliciesProcessDefinitionRestrictionApplier();

  @Test
  public void restrictToKeysAddFilterOnGivenKeys() {
    //given
    var keys = singleton("procDef");

    //when
    var filter = restrictionApplier.restrictToKeys(keys);
  ...
  public void denyAllShouldAddUnmatchableFilter() {
    //when
    var filter = restrictionApplier.denyAll();
