...
public class JsonNodeELResolver extends ELResolver {
   ...
   * enting a property on this bean, or null if the base object is null.
   */
  @Override
   ...
   * always return true. If a Map was created using java.util.Collections.unmodifiableMap(Map), this
   * method must return true. Unfortunately, there is no Collections API method to detect this.
   ...
   * @throws NullPointerException         if context is null, or if this map does not permit null
   ...
   * @throws ELException                  if an exception was thrown while performing the property
   *                                      or variable resolution. The thrown exception must be
