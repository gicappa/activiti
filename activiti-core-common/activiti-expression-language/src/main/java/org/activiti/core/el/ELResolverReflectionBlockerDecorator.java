...
public class ELResolverReflectionBlockerDecorator extends ELResolverDecorator {
  ...
  private static final Predicate<Method> IS_FINAL = method -> Modifier.isFinal(
    method.getModifiers());
  private static final Predicate<Method> IS_NATIVE = method -> Modifier.isNative(
    method.getModifiers());
  ...
  public Object invoke(
    ...
    var basePackageName = base.getClass().getPackageName();
