...
public class NumberOperationsTest extends TestCase {
  ...
  @Test
  public void testAdd() {
    assertEquals(0L, NumberOperations.add(converter, null, null));
  ...
  @Test
  public void testMul() {
    assertEquals(0L, NumberOperations.mul(converter, null, null));
  ...
  @Test
  public void testDiv() {
    assertEquals(0L, NumberOperations.div(converter, null, null));
  ...
  @Test
  public void testMod() {
    assertEquals(0L, NumberOperations.mod(converter, null, null));
  ...
  @Test
  public void testNeg() {
    assertEquals(0L, NumberOperations.neg(converter, null));
