 ...
 * <p>
 * This class is also used as an EL "service provider". The <em>juel-spi</em> jar file specifies
 * this class as el expression factory implementation in
...
public class ExpressionFactoryImpl extends ExpressionFactory {
   ...
   * A profile can be adjusted using the <code>activiti.juel.methodInvocations</code>,
  ...
  public enum Profile {
    ...
    /**
     * JEE6: <code>activiti.juel.methodInvocations</code>, <code>activiti.juel.varArgs</code>. This
   ...
   * builder and cache are configured from <code>el.properties</code> (see above). The maximum cache
   * size will be 1000 unless overridden in <code>el.properties</code>. The builder profile is
   * {@link Profile#JEE6} (features may be overridden in <code>el.properties</code>).
   */
  ...
  /**
   * Create a new expression factory using the default builder and cache implementations. The
   * builder and cache are configured from the specified profile and <code>el.properties</code> (see
   * above). The maximum cache size will be 1000 unless overridden in
  ...
  /**
   * Create a new expression factory using the default builder and cache implementations. The
   * builder and cache are configured using the specified properties. The maximum cache size will be
   * 1000 unless overridden by property <code>jakarta.el.cacheSize</code>. The builder profile is
  ...
  /**
   * Create a new expression factory using the default builder and cache implementations. The
   * builder and cache are configured using the specified profile and properties. The maximum cache
   * size will be 1000 unless overridden by property <code>jakarta.el.cacheSize</code>.
   *
  ...
  /**
   * Create the factory's tree store. This implementation creates a new tree store using the default
   * builder and cache implementations. The builder and cache are configured using the specified
   * properties. The maximum cache size will be as specified unless overridden by property
   * <code>jakarta.el.cacheSize</code>.
   */
   ...
   * <code>misc.org.activiti.core.el.juel.TypeConverter</code> property as the name of a class
   * implementing the <code>misc.org.activiti.core.el.juel.TypeConverter</code> interface. If the
   ...
   * <code>tree.org.activiti.core.el.juel.TreeBuilder</code> property as a name of a class
   * implementing the
   * <code>tree.org.activiti.core.el.juel.TreeBuilder</code> interface. If the property is not set,
   * a plain
   * <code>impl.tree.org.activiti.core.el.juel.Builder</code> is used. If the configured class is a
   * subclass of <code>impl.tree.org.activiti.core.el.juel.Builder</code> and which provides a
   * constructor taking an array of <code>Builder.Feature</code>, this constructor will be invoked.
